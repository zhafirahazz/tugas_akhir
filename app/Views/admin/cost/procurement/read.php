...
<div class="container-fluid mt-4">
    <h2 class="d-inline align-middle me-4 ">Item Procurement Cost</h2>
    <a class="d-inline align-middle" href="<?php echo route_to('procurement.item.create', $procurementId) ?>">
                            ...
                            foreach ($items as $index => $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-auto">
                                                <a href="<?php echo route_to('procurement.item.edit', $procurementId, $item["id"]) ?>"><button class="btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square fa-fw"></i> Edit</button></a>
                                                <form class="d-inline" method="post" action="<?php echo route_to('procurement.item.delete', $procurementId, $item["id"])?>" onclick="return confirm('Delete data?');">
