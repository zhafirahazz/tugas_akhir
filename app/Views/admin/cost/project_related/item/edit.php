...
<div class="container mt-4">
    <h2 class="d-inline align-middle me-4 ">Edit Item Project Related Cost</h2>

    <div class="row mt-4">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo route_to('projectrelated.item.update', $projectRelatedId, $items["id"]) ?>" method="post">
