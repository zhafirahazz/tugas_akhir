...
<div class="container-fluid mt-4">
    <h2 class="d-inline align-middle me-4">Project Related Cost</h2>
    <a class="d-inline align-middle" href="<?php echo route_to('projectrelated.create') ?>">
                            ...
                            foreach ($costs as $index => $cost) : 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-auto">
                                                <a href="<?php echo route_to('projectrelated.read', $cost["id"]) ?>"><button class="btn btn-primary btn-sm"><i class="fa-solid fa-eyes fa-fw"></i> Detail</button></a>
                                                <a class="d-inline" href="<?php echo route_to('projectrelated.edit', $cost["id"]) ?>"><button class="btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square fa-fw"></i> Edit</button></a>
                                                <form class="d-inline" method="post" action="<?php echo route_to('projectrelated.delete', $cost["id"]) ?>" onclick="return confirm('Delete data?');">
