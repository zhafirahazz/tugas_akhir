...
class ProjectRelatedController extends BaseController
{
    ...
    public function index()
    {
        $category = $this->Category
            ->where('category_name', 'project_related')
            ->first();
        ...
        $costs = $this->Cost
            ...
            ->findAll();
        return view('admin/cost/project_related/index', ["costs" => $costs]);
    }

    public function create()
    {
        // TO DISPLAY CREATE COST VIEW
        return view('admin/cost/project_related/create');
    }
    ...
    public function store()
    {
        ...
        return redirect()->route('projectrelated.index');
    }

    public function edit($id)
    {
        // TO DISPLAY EDIT COST VIEW
        $projectrelated = $this->Cost
            ->select('*')
            ->from('cost as c')
            ->where('c.id', $id)
            ->first();
        ...
        return view('admin/cost/project_related/edit', ["item" => $projectrelated, "units" => $unit]);
    }
    ...
    public function update($id)
    {
        ...
        $projectrelated = $this->Cost->where('id', $id)->set($data)->update();
        $message = "Data berhasil diubah!";
        $this->session->setFlashdata('alert', $message);
        return redirect()->to(route_to('projectrelated.index'));
    }
    ...
    public function read($id)
    {
        ...
        ")
            ...
            ->findAll();
        return view('admin/cost/project_related/read', ["items" => $items, "projectRelatedId" => $id]);
    }

    public function itemCreate($id)
    {
        // TO DISPLAY CREATE COST VIEW
        return view('admin/cost/project_related/item/create', ["costItemId" => $id]);
    }
    ...
    public function itemStore($id)
    {
        ...
        $message = "Data berhasil ditambahkan!";
        $this->session->setFlashdata('alert_success', $message);
        return redirect()->route('projectrelated.read', [$id]);
    }

    public function itemEdit($id, $itemId)
    {
        // TO DISPLAY EDIT COST VIEW
        $itemPR = $this->CostItem
            ->select('*')
        ...
        $unit = $this->Unit->findAll();
        return view('admin/cost/project_related/item/edit', ["projectRelatedId" => $id, "items" => $itemPR, "units" => $unit]);
    }
    ...
    public function itemUpdate($id, $itemId)
    {
        ...
        $itemPR = $this->CostItem->where('id', $itemId)->set($data)->update();
        $message = "Data berhasil diubah!";
        $this->session->setFlashdata('alert', $message);
        return redirect()->to(route_to('projectrelated.read', $id, $itemId));
    }
