...
class OngoingController extends BaseController
{
    ...
    public function index()
    {
        ...
        $costs = $this->Cost
            ...
            ->findAll();
        return view('admin/cost/ongoing/index', ["costs" => $costs]);
    }

    public function create()
    {
        // TO DISPLAY CREATE COST VIEW
        return view('admin/cost/ongoing/create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/cost/ongoing/edit', ["item" => $ongoing, "units" => $unit]);
    }
    ...
    public function update($id)
    {
        ...
        $ongoing = $this->Cost->where('id', $id)->set($data)->update();
        $message = "Data berhasil diubah!";
        $this->session->setFlashdata('alert', $message);
        return redirect()->to(route_to('ongoing.index'));
    }
    ...
    public function read($id)
    {
        ...
        ->findAll();
        return view('admin/cost/ongoing/read', ["items" => $items, "ongoingId" => $id]);
    }

    public function itemCreate($id)
    {
        // TO DISPLAY CREATE COST VIEW
        return view('admin/cost/ongoing/item/create', ["costItemId" => $id]);
    }
    ...
    public function itemStore($id)
    {
        ...
        $message = "Data berhasil ditambahkan!";
        $this->session->setFlashdata('alert_success', $message);
        return redirect()->route('ongoing.read', [$id]);
    }

    public function itemEdit($id, $itemId)
    {
        // TO DISPLAY EDIT COST VIEW
        $itemOngoing = $this->CostItem
            ->select('*')
        ...
        $unit = $this->Unit->findAll();
        return view('admin/cost/ongoing/item/edit', ["ongoingId" => $id, "items" => $itemOngoing, "units" => $unit]);
    }
    ...
    public function itemUpdate($id, $itemId)
    {
        ...
        $itemOngoing = $this->CostItem->where('id', $itemId)->set($data)->update();
        $message = "Data berhasil diubah!";
        $this->session->setFlashdata('alert', $message);
        return redirect()->to(route_to('ongoing.read', $id, $itemId));
    }
